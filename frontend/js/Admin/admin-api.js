...
class AdminAPIService {
    ...
    async getBookingAnalytics(period = 'monthly') {
        return this.makeRequest('GET', `/admin/dashboard/analytics?period=${period}`, null, true, true);
    }
    ...
    async getBookingDetails(id) {
        return this.makeRequest('GET', `/bookings/${id}`, null, true, false, false);
    }

    async updateBooking(id, bookingData) {
        return this.makeRequest('PUT', `/bookings/${id}`, bookingData, true, false, false);
    }
